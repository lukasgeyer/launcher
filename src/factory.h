...
public:
    ...
    */
   template <typename DerivedObjectType> inline void declare(const IdType& id, AdditionalInformationTypes&&... additionalInformations)
   {
   ...
   inline typename AdditionalInformationType<AdditionalInformationIndex>::type additionalInformation(const IdType& id) const
   {
    ...
    */
   inline ObjectType* create(const IdType &id) const
   {
